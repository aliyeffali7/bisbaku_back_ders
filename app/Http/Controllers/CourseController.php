...
class CourseController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = $request->only(['title', 'description', 'full_description', 'price', 'company_id']); // ✅ Добавлено company_id
        ...
        // Если поле отправлено как null (для удаления существующего изображения)
